  ...
  <Teleport to="body">
    <div class="fixed top-4 right-4 z-50 space-y-3 pointer-events-none">
      <TransitionGroup name="notification">
        ...
        >
          <div :class="getNotificationClass(notification.type)" class="p-4 flex items-start gap-3">
            <!-- Icon -->
            <div class="flex-shrink-0">
              ...
              <svg v-else-if="notification.type === 'warning'" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
            ...
            <button
              ...
              class="flex-shrink-0 rounded-lg p-1 hover:bg-black/5 transition-colors duration-200 cursor-pointer"
            >
